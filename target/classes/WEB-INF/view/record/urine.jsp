			...
			<div class="col-10 mx-auto px-0 m-2">
				...
				<div class="row col-12 m-0">
					<div class="form-check flex-fill col-6">
				        <input class="form-check-input" type="radio" value="正常" id="urobilirubin" name="urobilirubin">
				        <label class="form-check-label" for="bilirubin_normal">正常(normal)</label>
				    </div>
				    <div class="form-check flex-fill col-6">
				        <input class="form-check-input" type="radio" value="異常" id="urobilirubin" name="urobilirubin">
