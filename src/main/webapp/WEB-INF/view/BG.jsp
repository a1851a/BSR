	...
	<form class="row m-0 needs-validation" method="post" action="./BP"
			...
			<label for="exampleFormControlInput1" class="form-label">空腹血糖</label>
				<input type="number" class="form-control" id="AC" name="AC"
					placeholder="mg/dL" min="0" max="300" step="1" required>
				<div class="invalid-feedback">請輸入正確空腹血糖</div>
			</div>
			<div class="col-10 mx-auto px-0 m-2">
			<label for="exampleFormControlInput1" class="form-label">飯後血糖</label>
				<input type="number" class="form-control" id="PC" name="PC"
					placeholder="mg/dL" min="0" max="300" step="1">
				<div class="invalid-feedback">請輸入正確飯後血糖</div>
			</div>
			<div class="col-10 mx-auto px-0 m-2">
				<label for="exampleFormControlInput1" class="form-label">糖化血色素</label>
				<input type="number" class="form-control" id="HbA1c"
					name="HbA1c" placeholder="mmHg" min="0" max="300" step="1" required>
