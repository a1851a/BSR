...
<html>
	...
	<body>
	  	<!-- Logo -->
		<header class="container-fluid vw-100 fixed-top d-flex flex-nowrap align-items-center bg-dark">
			<span class="vw-100 text-center text-light">
				BSR
			</span>
			<span class="text-end">
				<a class="account bi bi-person-circle" href="./Login"></a>
			</span>
			<span class="text-end">
				<a class="back bi bi-arrow-left-circle" href="./Index"></a>
			</span>
		</header>